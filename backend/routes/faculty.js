...
const upload = multer({
  ...
  fileFilter: (req, file, cb) => {
    const allowedTypes = /jpeg|jpg|png|gif|pdf|doc|docx|ppt|pptx|mp4|avi|mov|xlsx|xls/
...
// Get faculty events - FIXED TO SHOW REGISTERED STUDENTS
...
// Download event registrations - FIXED
