...
import { Calendar, MapPin, Users, Clock, Plus, CheckCircle, XCircle, AlertCircle, Download } from "lucide-react"
...
const EventCard = ({ event, onRegister, onDownloadRegistrations }) => {
  const { user } = useAuth()
